...
class Welcome(tk.Tk):
    ...
    def buildFrame(self):
        ...
        title.pack()
        vnu = tk.Label(
            title, text="VIETNAM NATIONAL UNIVERSITY - HO CHI MINH CITY", font=("32")).grid(row=0)
        hmcut = tk.Label(
            title, text="HO CHI MINH CITY UNIVERSITY OF TECHNOLOGY", font=("32")).grid()
        cse = tk.Label(
            title, text="COMPUTER SCIENCE AND ENGINEERING FACULTY", font=("30")).grid()
        ...
        _ = tk.Label(
            body, text="________________________________________________").grid()
        titleName = tk.Label(
            body, text="Implement Caro Game", font=("28")).grid()
        # a = tk.Label(body,
        #             text="Choose what kind of play do you prefer:").grid()
        # onePlayerButton = tk.Button(body, text="1 player", width=10, command=partial(
        #    self.onePlayer))
        #onePlayerButton.grid(column=0, row=2)
        # twoPlayerButton = tk.Button(body, text="2 player", width=10, command=partial(
        #    self.twoPlayer))
